...
export const stays: Stay[] = [
  {
    ...
    description: "An entire one-bedroom home wrapped in warm tones — made for movie nights, slow coffee mornings and late conversations. The kind of place you quietly extend your stay in.",
    guests: 5,
    bedrooms: 1,
    beds: 1,
    bathrooms: 1,
    sleeping: ["Bedroom — 1 queen bed", "Living room — 1 sofa"],
    amenities: ["Wifi", "Kitchen", "Free parking on premises", "Lift", "Washing machine", "Bath", "Hairdryer"],
  ...
  },
  {
    ...
    location: "Arekere, Bengaluru",
    description: "A two-bedroom home curated in earthy tones and warm light. Every stay has a story — this one is designed for gathering, resting and reconnecting in the city.",
    guests: 6,
    bedrooms: 2,
    beds: 2,
    bathrooms: 2,
    sleeping: ["Bedroom 1 — 1 queen bed", "Bedroom 2 — 1 queen bed", "Living room — 1 sofa"],
    amenities: ["Wifi", "Kitchen", "Dedicated workspace", "Free parking on premises", "TV", "Lift", "Washing machine"],
